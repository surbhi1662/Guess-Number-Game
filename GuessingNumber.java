...
public class GuessingNumber {
    ...
    public static void guessingNumberGame() {
        ...
        System.out.println("Enter maximum value till you can choose: "); // To choose no from 1 to the no. choosen by
                                                                         // the user
        int gui = sc.nextInt(); // Input-1
        int number = 1 + (int) (gui * Math.random());
        System.out.println("Enter in how many attempts you think you can guess:"); // No of attempts the thinks they can
                                                                                   // guess in
